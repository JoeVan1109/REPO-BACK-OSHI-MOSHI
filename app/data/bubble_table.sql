...
((SELECT id FROM "bubble_tea" WHERE name = 'Bloody Mary'), (SELECT id FROM "tea" WHERE name = 'Violette')),
((SELECT id FROM "bubble_tea" WHERE name = 'Bloody Mary'), (SELECT id FROM "tea" WHERE name = 'Litchi')),
((SELECT id FROM "bubble_tea" WHERE name = 'Bloody Mary'), (SELECT id FROM "tea" WHERE name = 'Myrtille')),
...
-- Bubble Tea Zeus
((SELECT id FROM "bubble_tea" WHERE name = 'Bubble Tea Sirène'), (SELECT id FROM "tea" WHERE name = 'Thé noir')),
((SELECT id FROM "bubble_tea" WHERE name = 'Bubble Tea Sirène'), (SELECT id FROM "tea" WHERE name = 'Thé noir')),
((SELECT id FROM "bubble_tea" WHERE name = 'Bubble Tea Sirène'), (SELECT id FROM "tea" WHERE name = 'Thé noir')),
((SELECT id FROM "bubble_tea" WHERE name = 'Bubble Tea Sirène'), (SELECT id FROM "tea" WHERE name = 'Thé noir')),
((SELECT id FROM "bubble_tea" WHERE name = 'Bubble Tea Sirène'), (SELECT id FROM "tea" WHERE name = 'Thé noir')),
