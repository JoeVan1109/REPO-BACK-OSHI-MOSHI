...
DROP TABLE IF EXISTS "bar", "bubble_tea_tea", "bubble_tea_pearl", "bubble_tea_topping", "bubble_tea", "tea", "milk", "topping", "pearl", "collection" CASCADE;
...
-- Création de la table "bubbe_tea" avec toutes ses références
CREATE TABLE "bubble_tea" (l
    "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "name" text NOT NULL UNIQUE,
    "prixL" INTEGER NULL,
    "prixXL" INTEGER NULL,
...
DROP TABLE IF EXISTS collection_bubble_tea CASCADE;
